...
class OCILFAST(ContinualModel):
    ...
    def begin_task(self, dataset):
        ...
        if self.cpt is None:
            self.cpt = dataset.N_CLASSES_PER_TASK #2
            ...
            ## The lower triangle includes the diagonal is True, the upper triangle is False, used for masking
