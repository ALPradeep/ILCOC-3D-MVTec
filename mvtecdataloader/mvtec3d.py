...
class MVTec3DTrain(MVTec3D):
    def __init__(self, class_name, img_size):
        ...
        self.img_paths, self.labels = self.load_dataset(class_name)  # self.labels => good : 0, anomaly : 1

    def load_dataset(self, class_name):
        img_tot_paths = []
        tot_labels = []
        ...
        tot_labels.extend([class_label[class_name]] * len(sample_paths))
...
class MVTec3DTest(MVTec3D):
    def __init__(self, class_name, img_size):
        ...
        self.gt_transform = transforms.Compose([
            ...
            transforms.ToTensor()])
        self.class_name = class_name
        self.img_paths, self.gt_paths, self.labels = self.load_dataset(class_name)  # self.labels => good : 0, anomaly : 1
    ...
    def load_dataset(self,class_name):
        ...
        for defect_type in defect_types:
            if defect_type == 'good':
                ...
                tot_labels.extend([10] * len(sample_paths))
